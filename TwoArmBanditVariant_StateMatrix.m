...
if isfield(BpodSystem.ModuleUSB, 'WavePlayer1') % if also WavePlayer -> opto
    ...
    if strcmpi(WaitCInCh3End, 'Tonic')...
       ...
       && (TrialData.WaitCInCh3Trigger(iTrial)... 
       || TrialData.WaitCInCh3TonicSuppressed(iTrial))
    ...
    if strcmpi(WaitCInCh4End, 'Tonic')...
       ...
       && (TrialData.WaitCInCh4Trigger(iTrial)... 
       || TrialData.WaitCInCh4TonicSuppressed(iTrial))
...
if isfield(BpodSystem.ModuleUSB, 'WavePlayer1') % if also WavePlayer -> opto
    ...
    if strcmpi(CInCh3End, 'Tonic')...
       ...
       && (TrialData.CInCh3Trigger(iTrial)... 
       || TrialData.CInCh3TonicSuppressed(iTrial))
        CInCh3EndKey = 'None';
    end
    ...
    if strcmpi(CInCh4End, 'Tonic')...
       ...
       && (TrialData.CInCh4Trigger(iTrial)... 
       || TrialData.CInCh4TonicSuppressed(iTrial))
        CInCh4EndKey = 'None';
    end
...
if isfield(BpodSystem.ModuleUSB, 'WavePlayer1') % if also WavePlayer -> opto
    ...
    if strcmpi(SInCh3End, 'Tonic')...
       ...
       && (TrialData.SInCh3Trigger(iTrial)... 
       || TrialData.SInCh3TonicSuppressed(iTrial))
        SInCh3EndKey = 'None';
    end
    ...
    if strcmpi(SInCh4End, 'Tonic')...
       ...
       && (TrialData.SInCh4Trigger(iTrial)... 
       || TrialData.SInCh4TonicSuppressed(iTrial))
        SInCh4EndKey = 'None';
    end
...
if isfield(BpodSystem.ModuleUSB, 'WavePlayer1') % if also WavePlayer -> opto
    ...
    if strcmpi(WaterSCh3End, 'Tonic')...
       ...
       && (TrialData.WaterSCh3Trigger(iTrial)... 
       || TrialData.WaterSCh3TonicSuppressed(iTrial))
    ...
    if strcmpi(WaterSCh4End, 'Tonic')...
       ...
       && (TrialData.WaterSCh4Trigger(iTrial)... 
       || TrialData.WaterSCh4TonicSuppressed(iTrial))
...
if isfield(BpodSystem.ModuleUSB, 'WavePlayer1') % if also WavePlayer -> opto
    ...
    if strcmpi(SkippedFeedbackCh3End, 'Tonic')...
       ...
       && (TrialData.SkippedFeedbackCh3Trigger(iTrial)... 
       || TrialData.SkippedFeedbackCh3TonicSuppressed(iTrial))
    ...
    if strcmpi(SkippedFeedbackCh4End, 'Tonic')...
       ...
       && (TrialData.SkippedFeedbackCh4Trigger(iTrial)... 
       || TrialData.SkippedFeedbackCh4TonicSuppressed(iTrial))
